...
export default function Contact() {
  ...
  <div className='  pt-5 bg-caffe position-relative z-0' >
   <div className='position-absolute bg-dark w-100 h-100 z-1 opacity-50'></div>
    <img src="../../public/back3.jpg" alt="" className=' position-absolute w-100 h-100 pt-3 '  style={{zIndex:'0'}} />
    <div className='h-35 w-100 position-relative mt-0  z-3 d-flex align-items-center' >

      <div className='w-25 border border-2 border-light rounded-5 d-flex align-items-center  flex-column  pt-2 m-5' style={{backgroundColor:'#8f6644'}}>
   ...
   <div className=' position-absolute top-50 z-3  d-flex align-items-center' style={{left:'40%'}}>
